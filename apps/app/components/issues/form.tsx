      ...
      <form onSubmit={handleSubmit(handleCreateUpdateIssue)}>
              ...
              <div className="relative">
                <div className="flex justify-end -mb-2">
                  {issueName && issueName !== "" && (
                    <button
                      type="button"
                      className={`flex items-center gap-1 rounded px-1.5 py-1 text-xs hover:bg-gray-100 ${iAmFeelingLucky ? "cursor-wait" : ""
                        }`}
        ...
        <div className="-mx-5 mt-5 flex items-center justify-between gap-2 border-t px-5 pt-5">
          ...
          >
            ...
            <button
              type="button"
              className={`pointer-events-none relative inline-flex h-4 w-7 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent ${createMore ? "bg-theme" : "bg-gray-300"
            ...
            >
              ...
              <span
                aria-hidden="true"
                className={`pointer-events-none inline-block h-3 w-3 ${createMore ? "translate-x-3" : "translate-x-0"
